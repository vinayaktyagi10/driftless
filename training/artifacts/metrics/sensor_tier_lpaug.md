...
|---|---|---|---|---|---|---|
| **native phone** | — | — | 1.00× | 1.00× | 1.00× (35.23 m) | 1.00× |
| low-pass 4 Hz | 10.9 % | 8.7 % | 1.01× | 0.965× | **0.995×** (35.11 m) | 0.998× |
| low-pass 2 Hz | 33.2 % | 32.0 % | 1.034× | 0.878× | **0.987×** (34.72 m) | 1.002× |
| low-pass 1 Hz | 45.0 % | 43.2 % | 1.072× | 0.872× | **1.009×** (35.69 m) | 1.055× |
| low-pass 0.5 Hz | 50.0 % | 48.2 % | 1.624× | 0.896× | **1.477×** (52.86 m) | 1.504× |
